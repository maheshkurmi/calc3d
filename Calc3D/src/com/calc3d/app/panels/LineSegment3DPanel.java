...
public class LineSegment3DPanel extends Object3DCreatePanel  {
	...
	private Element3DLineSegment lineSegment3D;
	private Vector3D point1;
	private Vector3D point2;
	
	
	public LineSegment3DPanel(Element3DLineSegment object3D){
		lineSegment3D=object3D;
	...
	public Element3D getObject3D() {
		if (isValidInput()) {
			lineSegment3D=new Element3DLineSegment(point1,point2);
	...
	public void setObject3D(Element3D object3d) {
		if (!(object3d instanceof Element3DLineSegment)) return;
		lineSegment3D=(Element3DLineSegment) object3d;
		point1=lineSegment3D.getPoint1();
		point2=lineSegment3D.getPoint2();
		this.txtXcoord1.setValue(point1.getX());
		this.txtYcoord1.setValue(point1.getY());
